                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <form method="POST" action="{{ route('pay.now') }}">
                            @csrf
                            <button type="submit"
                                class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] border border-transparent hover:border-[#19140035] dark:hover:border-[#3E3E3A] rounded-sm text-sm leading-normal">
                                Pay Now
                            </button>
                        </form>
                    </li>
